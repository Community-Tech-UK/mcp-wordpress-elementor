...
const listPagesSchema = z.object({
  ...
  author: z.union([z.coerce.number(), z.array(z.coerce.number())]).optional().describe('Limit results to pages assigned to specific authors'),
  parent: z.coerce.number().optional().describe('Limit results to pages with a specific parent ID'),
  status: z.enum(['publish', 'future', 'draft', 'pending', 'private']).optional().describe('Limit results to pages with specific status'),
  menu_order: z.coerce.number().optional().describe('Limit results to pages with a specific menu_order'),
...
const getPageSchema = z.object({
  id: z.coerce.number().describe('Unique identifier for the page'),
}).strict();
...
const createPageSchema = z.object({
  ...
  author: z.coerce.number().optional().describe('The ID for the author of the page'),
  featured_media: z.coerce.number().optional().describe('The ID of the featured media for the page'),
  parent: z.coerce.number().optional().describe('The ID for the parent of the page'),
  menu_order: z.coerce.number().optional().describe('The order of the page in relation to other pages'),
